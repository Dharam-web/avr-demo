...
import { navUpper } from "@/components/navbar/navData";
...
const offers = [
    "FESTIVE OFFER GET UPTO 20% OFF ON YOUR STAY",
...
const Header: React.FC = () => {
    ...
    return (
        <>
            <section className="max_screen_width py-8 md:py-16 bg-[#F9F9F1] demo !py-0 flex items-center">
                {/* Swiper */}
                <SwiperCarousel
                    data={offers}
                    modules={[Autoplay]}
                    ...
                    renderSlide={(text) => (
                        <div className="py-3 w-full">
                            <div className="relative">
                                <p className="text-clr text-wrap lg:text-nowrap font-semibold text-xl text-center max-sm:px-12 uppercase">
                                    {text}
                                </p>
                            </div>
                        </div>
                ...
                <a
                    ...
                    className="border border-clr1 justify-center items-center lg:px-8 text-nowrap py-4 px-4 max-lg:hidden text-sm flex gap-2 text-white bg-clr1 hover:text-clr hover:bg-transparent transition-all"
                >
                    Book Now
                    <span>
