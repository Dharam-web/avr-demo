...
const EnquiryForm: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Read phone from intl-tel-input (uncontrolled), fallback to input + selected country code
  ...
  return (
    <div className="flex items-center justify-center">
      <form
        ...
        className="w-full max-w-xl bg-white shadow-xl rounded-xl p-8 space-y-6"
      >
        {/* Name */}
        <div>
